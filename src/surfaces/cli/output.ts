...
export function buildCliUsage(): string {
  return [
    ...
    "  team issue-token --subject <id> --role <viewer|contributor|admin> [--secret <jwt>] [--ttl <sec>]",
    ...
    "  skill sync <export|import|push|pull> [--path <file>] [--force]  # git-committable team skill package; push/pull talk to mcp-http team server; import/pull MERGE",
