...
function resolveRuntimeConfig(configPath?: string, rootDir?: string) {
...
function closeGraphClient(client: GraphClient): void {
  try {
    ...
    // Windows keeps the sqlite file locked if close throws after a failed open.
  }
}
...
async function existingSkillUpdatedAt(
  client: GraphClient,
  id: string
