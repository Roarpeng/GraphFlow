...
> Last run: 2026-08-02T01:08:53.394Z
...
- **Baseline total input tokens:** 262,926
- **GraphFlow total input tokens:** 2,843
- **Overall token savings:** **98.9%**
...
| --- | --- | --- | --- | --- |
| `orchestrator` | 32,784 (10 files) | 376 | 232 | 98.9% |
| `context compression` | 31,663 (10 files) | 436 | 309 | 98.6% |
| `model routing` | 23,245 (10 files) | 419 | 280 | 98.2% |
| `graph index` | 40,281 (10 files) | 326 | 208 | 99.2% |
| `token savings` | 33,870 (10 files) | 440 | 293 | 98.7% |
| `semantic enrichment` | 22,469 (10 files) | 224 | 128 | 99.0% |
| `preview context` | 29,542 (10 files) | 302 | 180 | 99.0% |
| `skill flywheel` | 49,072 (10 files) | 320 | 216 | 99.3% |
| **Total** | **262,926** | **2,843** | **1,846** | **98.9%** |
...
- Graph nodes in store: 3,480
- Files (re)indexed this run: 335 (0 = incremental, graph already current)
- Benchmark wall-clock: 4.2s
